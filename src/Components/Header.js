...
export default function Header({func}) {
  ...
  return (
    <div className="bg-white bg-opacity-25 sticky top-0 z-10 w-full border-b-2 grid grid-flow-col grid-cols-2 pr-2 h-12">
      ...
      <div className={active === "All" ? buttonClass + activeButtonClass : buttonClass }  onClick={() => {setActive("All"); func("All")}}>All Characters</div>
      <div className={active === "Name" ? buttonClass + activeButtonClass : buttonClass }  onClick={() => {setActive("Name"); func("Name")}}>Filter By Name</div>
      </div>
